...
upper_east_side = Neighborhood.find_or_create_by(name: "Upper Eastside")
edgewater = Neighborhood.find_or_create_by(name: "Edgewater")
aventura = Neighborhood.find_or_create_by(name: "Aventura")
bal_harbour = Neighborhood.find_or_create_by(name: "Bal Harbour")
doral = Neighborhood.find_or_create_by(name: "Doral")
kendall = Neighborhood.find_or_create_by(name: "Kendall")
